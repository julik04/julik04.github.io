        ...
        <div className="catalogue">
          <div className="list">
            <ExpandableItem
              ...
              onCategorySelect={(category) => handleCategorySelect(category, "Всё для татуировки")}
            ...
            <ExpandableItem
              ...
              selectedCategory={selectedCategory}
              selectedSubcategory={selectedSubcategory}
              onCategorySelect={(category) => handleCategorySelect(category, "Всё для пирсинга")}
              onSubcategorySelect={handleSubcategorySelect}
            ...
            <ExpandableItem
              ...
              selectedCategory={selectedCategory}
              selectedSubcategory={selectedSubcategory}
              onCategorySelect={(category) => handleCategorySelect(category, "Всё для студии")}
              onSubcategorySelect={handleSubcategorySelect}
